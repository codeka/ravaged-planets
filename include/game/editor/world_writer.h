...
private:
  ...
  void write_terrain(rp::world_file &wf);
  void write_mapdesc(rp::world_file &wf);
  void write_minimap_background(rp::world_file &wf);
  void write_collision_data(rp::world_file &wf);
