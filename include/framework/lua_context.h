...
/**
 * This class represents the LUA context. It's the main object you'll create when creating an interface to LUA and it
 * allows you to call scripts, register objects, functions and callbacks and so on.
 */
